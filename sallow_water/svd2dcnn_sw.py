...
from svd2d import SVD2d, CONV2D
...
"""
 bsub -q normal -gpu num=1:mode=exclusive_process -M 80G -n 32  -o /baselines/cnn/sw_cnn.txt python -u /sallow_water/svd2dcnn_sw.py
