...
model = DeepONetCartesianProd2D(
    ...
    query_dim=1,
    out_channel = out_dim*grid_size_y).to(device)
...
"""
 bsub -q normal -gpu num=1:mode=exclusive_process -M 80G -n 32  -o /baselines/deeponet/sw2_deeponet.txt python -u /sallow_water/deeponet2d_sw.py
"""