...
- Swaps the model from `SVD1d` to `STU1d` (spatial STU operator)
    ...
    python stu_ds.py \
        ...
        --num_eigenfunc 20 --lifting_dim 64
"""
...
from stu3d_mlp_vars_rand import STU3d
...
"""
 bsub -q normal -gpu num=1:mode=exclusive_process -M 100G -n 32  -o /mx3_stu.txt python -u /mx3/stu_mx3_mlp_random.py

bsub -q normal -gpu num=1:mode=exclusive_process -M 200G -n 32 \
  -o /mx3_20_32_f_r.txt \
  python -u /mx3/stu_mx3_mlp_random.py\
  --num_eigenfunc 20 \
  --lifting_dim 32 \
  --random_seed 0
