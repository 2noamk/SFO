...
sys.path.append("/baselines/unet")
from unet import *
...
model = UNet3d(in_channels=in_channel, num_vars=num_vars, out_dim=out_dim, initial_step=initial_step).to(device)
...
"""
 bsub -q normal -gpu num=1:mode=exclusive_process -M 80G -n 32  -o /baselines/unet/mx3_unet.txt python -u /mx3/unet3d_mx.py
...
bsub -q normal -gpu num=1:mode=exclusive_process -M 200G -n 32 \
  -o /baselines/unet/mx3_unet.txt \
  python -u /mx3/unet3d_mx.py \
  --random_seed 0
