...
"""
 bsub -q normal -gpu num=1:mode=exclusive_process -M 80G -n 32  -o /baselines/fno/mx3_fno_rt6.txt python -u /mx3/fno3d_mx3.py


bsub -q normal -gpu num=1:mode=exclusive_process -M 200G -n 32 \
  -o /baselines/fno/mx3_fno.txt \
  python -u /mx3/fno3d_mx3.py \
  --random_seed 0
