...
from stu3d_glu_vars import STU3d
...
"""
 bsub -q normal -gpu num=1:mode=exclusive_process -M 100G -n 32  -o /mx3_stu.txt python -u /mx3/stu_mx3_glu.py

  
bsub -q normal -gpu num=1:mode=exclusive_process -M 200G -n 32 \
  -o /mx3_20_32_glu_r.txt \
  python -u /mx3/stu_mx3_glu.py\
  --num_eigenfunc 20 \
  --lifting_dim 32 \
  --random_seed 0
