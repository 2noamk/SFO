...
"""
 bsub -q normal -gpu num=1:mode=exclusive_process -M 200G -n 32  -o /ch_16_stu.txt python -u /cahn_hilliard/stu_ch.py


  
bsub -q normal -gpu num=1:mode=exclusive_process -M 200G -n 32 \
  -o /ch_20_64.txt \
  python -u /cahn_hilliard/stu_ch.py\
  --num_eigenfunc 20 \
  --lifting_dim 64 \
  --random_seed 0
