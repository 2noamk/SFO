...
_, x_test, y_test, _, test_loader = read_single_data(
    ...
    batch_size=batch_size,
    initial_step=initial_step,
    reduced_resolution=reduced_resolution * 4,
    reduced_resolution_t=reduced_resolution_t,
    reduced_batch=1,
    test_ratio=0.1)
...
"""
 bsub -q normal -gpu num=1:mode=exclusive_process -M 80G -n 32  -o /baselines/fno/ch1_fno_vary_4.txt python -u /cahn_hilliard/fno1d_ch1_vary.py
