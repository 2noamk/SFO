...
"""
 bsub -q normal -gpu num=1:mode=exclusive_process -M 80G -n 32  -o /baselines/fno/ch1_pino.txt python -u /cahn_hilliard/pino1d_ch1.py
 
 
 

bsub -q normal -gpu num=1:mode=exclusive_process -M 200G -n 32 \
  -o /baselines/fno/ch1_pino.txt \
  python -u /cahn_hilliard/pino1d_ch1.py \
  --random_seed 0
