...
from read_data import read_single_data_one_step
...
def main():
    ...
    x_train, x_test, y_test, train_loader, test_loader = read_single_data_one_step(
...
bsub -q normal -gpu num=1:mode=exclusive_process -M 200G -n 32 \
  -o /ch_20_64_mlp_one_step.txt \
  python -u /cahn_hilliard/stu_ch_mlp_one_step.py \
  --num_eigenfunc 20 \
  --lifting_dim 64 \
  --random_seed 0
