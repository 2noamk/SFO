...
"""
 bsub -q normal -gpu num=1:mode=exclusive_process -M 80G -n 32  -o /baselines/deeponet/ch1_deeponet.txt python -u /cahn_hilliard/deeponet1d_ch.py
 
 

bsub -q normal -gpu num=1:mode=exclusive_process -M 200G -n 32 \
  -o /baselines/deeponet/ch1_deeponet.txt \
  python -u /cahn_hilliard/deeponet1d_ch.py \
  --random_seed 0
