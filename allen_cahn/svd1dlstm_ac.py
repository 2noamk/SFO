...
parser.add_argument("--num_eigenfunc", type=int, default=7)
...
"""
 bsub -q normal -gpu num=1:mode=exclusive_process -M 80G -n 32  -o /baselines/lstm/lstm_ac.txt python -u /allen_cahn/svd1dlstm_ac.py
