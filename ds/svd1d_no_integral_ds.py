...
sys.path.append('/baselines/only_svd')
from svd1d_no_integral import SVD1d, MLP1D, LSTM1D
...
log_mem("after training", proc)

"""
 bsub -q normal -gpu num=1:mode=exclusive_process -M 80G -n 32  -o /log_files/ds_svd_bo_integral.txt python -u /ds/svd1d_no_integral_ds.py
